  ...
  return (
    <div className="built-with font-fjalla flex flex-col w-full text-center mt-5 gap-4">
      ...
      <div className="flex justify-center">
        <div className="built-with-images bg-cream p-3 rounded-full flex flex-wrap gap-2 cursor-pointer hover:animate-wiggle hover:animate-infinite hover:animate-duration-2000 justify-center">
          {react}
          {tailwind}
          {redux}
          {bootstrap}
